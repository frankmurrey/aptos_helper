...
# Changes made to the original library file: added the ability to use a proxy in httpx client
...
from aptos_sdk.authenticator import Authenticator, Ed25519Authenticator, MultiAgentAuthenticator
...
class CustomRestClient:
    ...
    def __init__(self, base_url: str, proxies: dict = None, client_config: ClientConfig = ClientConfig()):
...
class FaucetClient:
    ...
    base_url: str
    rest_client: CustomRestClient

    def __init__(self, base_url: str, rest_client: CustomRestClient):
        self.base_url = base_url
